...
@Component
public class VideoPubSubRepository {

    public static String TABLE_NAME = "PUB_SUB_VIDEO";
    ...
    public VideoPubSubRepository(ConnectionPoolManager connectionPoolManager) throws SQLException {
